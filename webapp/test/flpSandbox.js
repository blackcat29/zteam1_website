		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Home Page",
									"targetURL": "#zteam1website-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zteam1website-display": {
								"semanticObject": "zteam1website",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zteam1website",
									"url": sap.ui.require.toUrl("zteam1website")
								}
							}
						}
					}
